                  ...
                  <div key={sIdx}>
                    ...
                    <ul className="space-y-2.5">
                      {sub.topics.map((topic, tIdx) => (
                        <li 
                          key={tIdx} 
                          className="flex items-center gap-4 px-4 py-3 bg-[#0f172a]/40 hover:bg-orange-500/5 border border-white/5 hover:border-orange-500/20 rounded-xl text-slate-300 text-sm md:text-base transition-all duration-300 cursor-default group hover:translate-x-1"
                        >
                          <div className="flex-shrink-0 w-7 h-7 rounded-lg bg-orange-500/10 text-orange-400 flex items-center justify-center font-mono text-xs font-semibold group-hover:bg-orange-500 group-hover:text-white transition-all duration-300">
