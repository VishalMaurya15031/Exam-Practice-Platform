                  ...
                  <div key={sIdx}>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {sub.topics.map((topic, tIdx) => (
                        <div 
                          key={tIdx} 
                          className="px-4 py-2 bg-[#0f172a]/60 border border-white/5 rounded-lg text-slate-300 text-sm hover:bg-pink-500/10 hover:border-pink-500/30 hover:text-pink-300 transition-all duration-300 cursor-default"
                        >
                          {topic}
                        </div>
                      ))}
